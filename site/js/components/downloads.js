document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    link('[data-download="exe"], [data-installer]', exe?.browser_download_url || release.html_url || fallback);
    link('[data-download="zip"], [data-portable]', zip?.browser_download_url || release.html_url || fallback);
